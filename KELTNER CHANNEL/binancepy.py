...
CREDIT: This is work by tranl (see more details on: https://github.com/lambdamirror/Algo-Trading-In-Python),
        as well as a modified version from the original module of morozdima (for more information please visit: https://github.com/morozdima/BinanceFuturesPy)
