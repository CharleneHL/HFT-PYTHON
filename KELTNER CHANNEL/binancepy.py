...
CREDIT: This is work from tranl and also a modified version from the original module of morozdima.
        For more information, please visit: https://github.com/morozdima/BinanceFuturesPy; https://github.com/lambdamirror/Algo-Trading-In-Python
